...
class Kuliner_model extends CI_Model{
    ...
    public function getAllData(){
       ...
       $query = $this->db->get('kuliner_depok');
       return $query;
    }
    ...
    public function findById($id){
       ...
       $query = $this->db->get_where('kuliner_depok',['id'=>$id]);
       return $query->row();
    }
    ...
    public function update($data,$id){
        ...
        $this->db->update('kuliner_depok',$data,array('id'=>$id));
    }
    ...
    public function save($data){
        ...
        return $this->db->insert('kuliner_depok',$data);
    }
