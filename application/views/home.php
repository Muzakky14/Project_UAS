      ...
      <div class="container">
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link active" href="<?=base_url()?>index.php/welcome/index">Home</a>
            </li>
            <li class="nav-item">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="owl-carousel owl-theme">
            <div class="col-md-12">
              <div class="card" style="background: white;, url(assets/imgs/kubah/thumb-0.jpg);">
               
              <img src="<?= base_url('frontend/assets/imgs/kubah/thumb-0.jpg') ?>" alt="" width="400px">
            ...
            <div class="col-md-12">
              <div class="card" style="background: white;, url(assets/imgs/kopinako/thumb-0.jpg); ?>">
              
              <img src="<?= base_url('frontend/assets/imgs/kopinako/thumb-0.jpg') ?>" alt="" width="400px">
            ...
            <div class="col-md-12">
              ...
              <img src="<?= base_url('frontend/assets/imgs/wiladatika/thumb-0.jpg') ?>" alt="" width="400px">  
              <div class="card-category">Rekreasi</div>
                <div class="card-description">
            ...
            <div class="col-md-12">
              <div class="card" style="background: white; url(assets/imgs/drumbs/thumb-0.jpg">
              <img src="<?= base_url('frontend/assets/drumbs/thumb-0.jpg') ?>" alt="" >
                <div class="card-category">Kuliner</div>
                <div class="card-description">
                  <h5>Walking Drums</h5>
                  <ul class="list-inline small">
            ...
            <div class="col-md-12">
              <div class="card" style="background: white;, url(assets/imgs/d-kandang/thumb-0.jpg);">
              <img src="<?= base_url('frontend/assets/imgs/d-kandang/thumb-0.jpg') ?>" alt="" width="400px">
                <div class="card-category">Rekreasi</div>
                <div class="card-description">
            ...
            <div class="col-md-12">
              <div class="card" style="background: white;, url(assets/imgs/louis/thumb-0.jpg);">
              <img src="<?= base_url('frontend/assets/imgs/louis/thumb-0.jpg') ?>" alt="" width="400px">
                <div class="card-category">Kuliner</div>
                <div class="card-description">
                  <h5>Louis Cafe</h5>
                  <ul class="list-inline small">
      ...
      <div class="container-fluid p-0">
        <div class="row no-gutters">
          <div class="col-12 col-sm-6 col-lg-3 order-sm-1 order-xl-1">
            <img class="img-fluid" src="<?= base_url('frontend/assets/imgs/profile/aulia.jpg') ?>" alt ="">
            </div>
          ...
          <img  class="img-fluid" src="<?= base_url('frontend/assets/imgs/profile/dian.jpg') ?>" alt ="" >
          </div>
        ...
        <div class="row no-gutters">
          ...
          <img class="img-fluid" src="<?= base_url('frontend/assets/imgs/profile/salwa.jpg') ?>" alt ="" >
          </div>
          ...
          <img class="img-fluid" src="<?= base_url('frontend/assets/imgs/profile/zakky.jpg') ?>" alt ="" >
          </div>
